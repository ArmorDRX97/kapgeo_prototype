...
export const userPersonas: UserPersona[] = [
  { id: 'geo.ivanova', name: 'Ирина Иванова', initials: 'ИИ', position: 'Геолог', roles: ['R1'], scope: 'Сарытау · Северный', homeRoute: '/geology/bgd' },
  { id: 'gis.askarov', name: 'Аскар Аскаров', initials: 'АА', position: 'Геофизик-интерпретатор', roles: ['R2'], scope: 'Сарытау · Северный', homeRoute: '/geology/bgd' },
  { id: 'reserves.lee', name: 'Марина Ли', initials: 'МЛ', position: 'Инженер по запасам', roles: ['R3'], scope: 'Сарытау', homeRoute: '/geology/bgd' },
...
export const defaultPersona = userPersonas.find((persona) => persona.id === 'geo.ivanova') ?? userPersonas[0]!
