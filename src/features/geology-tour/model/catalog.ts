...
const geobase: GeologyTourStep[] = [
  ...
  step('bgd-registry', '/geology/bgd', target('[data-geology-tour="bgd-registry"]'), 'БГД', 'Поиск и выбор месторождения', 'Реестр показывает неизменяемый числовой код, названия RU/KZ/EN, тип, систему координат, видимость и текущее месторождение.'),
  step('bgd-filters', '/geology/bgd', target('[data-geology-tour="bgd-filters"]'), 'БГД', 'Фильтры реестра', 'Найдите месторождение по коду или названию на любом языке, отсортируйте список и отдельно покажите скрытые объекты.'),
  step('bgd-create', '/geology/bgd', target('[data-geology-tour="bgd-create"]'), 'БГД', 'Создание месторождения', 'Задайте уникальный числовой код, названия на трёх языках, тип, необязательную систему координат, описания и список залежей.'),
