...
export function GeologyMasterPage() {
  ...
  return <div className="page-stack">
    <PageHeader eyebrow="Геологический модуль" title="Месторождения и кондиции" description="Месторождение, участок, залежь и набор кондиций." actions={<Button onClick={() => setShowCreate(true)}><Plus size={16} /> Месторождение</Button>} />
