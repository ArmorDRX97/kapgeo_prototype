  ...
  return <div className="page-stack">
    ...
    <div className="profile-grid">
      ...
      {!preferences?.minimumMode && <>
        ...
        <Panel title="Безопасность"><div className="security-summary"><span className="security-summary__icon"><KeyRound size={19} /></span><div><strong>Парольная авторизация</strong><p>Текущий сеанс активен в этом браузере</p></div><Badge tone="success" variant="status">Активно</Badge></div></Panel>
