...
Основная ветка содержит самостоятельный рабочий модуль БГД в расширяемой многомодульной оболочке. Геология, технология, моделирование и аналитика представлены безопасными заглушками, администрирование — минимальным рабочим контуром. Полный прежний прототип зафиксирован в ветке `archive/full-prototype-2026-09-15`; эту ветку не следует использовать для текущей разработки.
